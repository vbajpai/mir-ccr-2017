...
%-- Michio Honda
\subsection{PASTE: A Networking Interface for Non-Volatile Main Memory}
...
%-- Ermias Walelgne
\subsection{Measuring The Performance of Cellular Link From Mobile Users}


%-- Roberto Morabito
\subsection{Lightweight Virtualization as Enabling Technology forFuture Smart Cars}
...
%-- Teemu Kärkkäinen
\subsection{Practical Opportunistic Content Dissemination Performance in Dense Network Segments}


%-- Daniel Herzog
\subsection{Recommender Systems and Mobility Services}
...
%-- Lars Wischhof
\subsection{Hybrid Solutions for Data Dissemination in Vehicular Networks}
