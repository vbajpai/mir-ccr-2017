...
\subsection{User Tracking Based on TLS CCA} %(TMA'17) -- can scale to 15 to 25 min —
...
%-- Hannes Tschofenig
\subsection{IoT Security: TrustZone for v8-M}
...
%-- Florian Westphal
\subsection{State of Linux Network Development} \label{fwestphal}
