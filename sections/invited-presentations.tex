...
SDN and ETSI NFV silently rely on pre-established, fixed control networks;
opening these up for programmability currently bears risks with respect to the
integrity of the control plane easily leading to e.g. a self-lockout. To
overcome this, he proposes a new model and a new protocol, a sort of a least
common denominator for software networks, whose only well-defined purpose it
is to autonomously construct, adjust and maintain control plane including the
placement of control compute nodes and control paths without presuming any
particular network purpose.
