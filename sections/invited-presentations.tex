...
fast re-route framework supporting both local and remote failures~\cite{} \todo[inline]{missing cite}.
...
of a remote failure with high accuracy (\todo[inline]{what's with the ``?'' ?}?93\%); and ii) SWIFT encoding scheme
